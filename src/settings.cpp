...
void settings::fill_all(void)
{
    ...
    prog_set -> fill_all();
    Notebook1->AddPage(prog_set, _("Program"));

    conn_set = new conn_set_panel(Notebook1);
    conn_set -> confi = confi;
    conn_set -> set_now = set_now;
    conn_set -> fill_all();
    Notebook1->AddPage(conn_set, _("Connection"));
